...
export class GenerateDailyReportDto {
  @ApiProperty({
    description: 'Ngày tạo báo cáo (tùy chọn, mặc định là ngày hiện tại)',
    example: '2024-09-06',
    required: false
  })
  @IsDateString()
...
export class GetReportByDateRangeDto {
  @ApiProperty({
    description: 'Ngày bắt đầu cho phạm vi báo cáo',
    example: '2023-05-01',
    required: true
  })
  @IsDateString()
  ...
  @ApiProperty({
    description: 'Ngày kết thúc cho phạm vi báo cáo',
    example: '2023-05-31',
    required: true
  })
  @IsDateString()
