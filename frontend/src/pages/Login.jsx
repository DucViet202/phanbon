...
const Login = () => {
  ...
  return (
    <main className="bg-[url('./assets/BG-Login.jpg')] w-screen h-screen bg-cover bg-no-repeat bg-center flex items-center justify-center">
      <div className="bg-white bg-opacity-90 p-10 rounded-3xl shadow-lg w-full max-w-md">
        <h1 className="text-3xl font-bold text-blue-500 text-center mb-8">ADMIN LOGIN</h1>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-blue-500 text-white py-3 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 mt-6"
          >
            Log in
          </button>
        </form>
