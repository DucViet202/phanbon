  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      <div className="p-4 md:p-6 flex-shrink-0">
        <h1 className="text-2xl md:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#1E3A8A] to-[#93C5FD] mb-4 text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 md:space-x-4 mb-6">
          <div className="flex w-full md:w-auto space-x-2">
            <div className="relative flex-grow">
              <input
                ...
                className="w-full p-2 pl-10 pr-4 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:border-transparent"
              />
              <FaSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
            </div>
            <button
              onClick={() => setIsFilterOpen(!isFilterOpen)}
              className="p-2 bg-white border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] hover:bg-gray-100"
            >
          ...
          <button
            ...
            className="w-full md:w-auto px-4 py-2 bg-blue-700 text-white rounded-full flex items-center justify-center space-x-2 hover:bg-[#1E3A8A] focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:ring-opacity-50"
          >
            <FaPlus />
        ...
        {isFilterOpen && (
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 mb-4">
            <DatePicker
              ...
              className="w-full md:w-auto p-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:border-transparent"
