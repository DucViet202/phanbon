        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          ...
          <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4 w-full md:w-auto">
            ...
            <select
              ...
              className="w-full md:w-auto p-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:border-transparent transition-all duration-300 ease-in-out"
            >
