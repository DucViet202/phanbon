...
const SaleBill = () => {
  ...
  const CustomInput = React.forwardRef(({ value, onClick }, ref) => (
    <button
      className="w-full p-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:border-transparent text-left"
      onClick={onClick}
      ref={ref}
    >
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      <div className="p-4 md:p-6 flex-shrink-0">
        <h1 className="text-2xl md:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#1E3A8A] to-[#93C5FD] w-full text-center md:text-left mb-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="relative w-full md:w-64">
              <input
                ...
                className="w-full p-2 pl-10 pr-4 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:border-transparent bg-white shadow-sm"
              />
        ...
        {isFilterOpen && (
          <div className="bg-white p-4 w-full md:w-1/2 md:ml-0 rounded-lg shadow-md mb-6 transition-all duration-300 ease-in-out">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative">
                <select
                  value={statusFilter}
                  onChange={handleStatusFilterChange}
                  className="w-full p-2 pl-10 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:border-transparent appearance-none bg-white"
                >
