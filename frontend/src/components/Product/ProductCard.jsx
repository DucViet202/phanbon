    ...
    <>
      <div className="hidden md:grid grid-cols-8 gap-4 p-4 items-center hover:bg-gray-50 transition-colors duration-150">
        ...
        <div className="col-span-1">
          <button 
            onClick={openModal}
            className="w-full bg-gradient-to-r from-[#1E3A8A] to-[#93C5FD] text-white px-3 py-1 rounded-full hover:shadow-lg transition-all duration-300 ease-in-out font-semibold transform hover:scale-105 text-sm"
            disabled={isUpdating}
          >
      ...
      <div className="md:hidden p-4 space-y-2">
        ...
        <button 
          onClick={openModal}
          className="w-full bg-gradient-to-r from-[#1E3A8A] to-[#93C5FD] text-white px-4 py-2 rounded-full hover:shadow-lg transition-all duration-300 ease-in-out font-semibold transform hover:scale-105 text-sm mt-2"
          disabled={isUpdating}
        >
          {isUpdating ? 'Đang cập nhật...' : 'Chi tiết'}
        </button>
