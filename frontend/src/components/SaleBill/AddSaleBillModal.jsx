        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <button
              type="button"
              onClick={addItem}
              className="mt-2 px-4 py-2 bg-gradient-to-r from-[#1E3A8A] to-[#93C5FD] text-white rounded-full hover:shadow-lg transition-all duration-300 ease-in-out font-semibold transform hover:scale-105"
            >
              Thêm sản phẩm
            </button>
          </div>
