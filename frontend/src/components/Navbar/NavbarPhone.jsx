      ...
      <div className="w-full flex flex-row py-2">
        ...
        <div className="w-9/12 ">
          <h1 className="text-2xl font-extrabold leading-tight text-center">
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#003366] to-[#66CCFF]">
              QUẢN LÝ
            </span>
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#66CCFF] to-[#003366] mt-1">
              PHÂN BÓN
            </span>
          </h1>
        </div>
